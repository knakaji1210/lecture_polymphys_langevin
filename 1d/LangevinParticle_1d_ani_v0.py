...
fig_title = "1-dimensional Langevin Particle ({0} steps, d$t$ = 0.1 ms)".format(N)
...
ax = fig.add_subplot(111, title=fig_title, xlabel='$t$ [ms]', ylabel='$X$ [um]',
...
LangevinParticle_1d = amp.blocks.Line(t_array_steps, x_array_steps, ax=ax, ls='-', marker="o", markersize=2, color='blue')

timeline = amp.Timeline(steps, units=' steps', fps=30)

anim = amp.Animation([LangevinParticle_1d], timeline)
anim.controls()

savefile = "./gif/LangevinParticle_1d_{0}steps".format(N)
